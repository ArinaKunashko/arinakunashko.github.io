    ...
    <section id="CV" class="bg-backgroundResume pa-10">
        ...
        <div style="width: 100%;">
            <v-timeline v-if="!isMobile" align="start" >
                <v-timeline-item v-for="(experience, i) in experiences" :key="i" :dot-color="experience.color" size="small">
                    ...
                    <div>
                        ...
                        <p v-if="experience.achievements !== ''" class="text-subtitle-2 mt-2">{{ $t('achievements') }}</p>
                        <p class="text-body-2">
            ...
            <v-timeline v-if="isMobile" side="end" align="start" class="px-lg-16 mx-lg-9 px-sm-3">
                <v-timeline-item v-for="(experience, i) in experiences" :key="i" :dot-color="experience.color" size="small">
                    ...
                    <div>
                        ...
                        <p class="text-subtitle-2 mt-2">Обязанности</p>
                        <p class="text-body-2">
                            {{ experience.role }}
                        </p>
                        <p v-if="experience.achievements !== ''" class="text-subtitle-2 mt-2">Достижения</p>
                        <p class="text-body-2">
                            {{ experience.achievements }}
                        </p>
                    </div>

...
export default {
  ...
  skills: 'Skills',
  techno: 'Technologies: JavaScript, Git, Docker, Firebase, HTML, CSS, Webpack, Vita',
  libr: 'Frameworks / Libraries: Vue.js, Vuex, Nuxt, Vuetify, Axios, Tailwind CSS, Tailwind UI, Material UI, Bootstrap, Bulma',
